...
//        var fileParser = SwiftParser.Parser(packageSwift)
//        let scanner = SyntaxScanner(file: .parse(from: &fileParser))
...
//        ]
//
//        scanner.scanForPattern(start: <#T##TokenSyntax?#>, pattern: <#T##MutableCollection#>)
//
//        let start = try XCTUnwrap(fileParser.firstToken)
